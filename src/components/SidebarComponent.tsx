  ...
  return (
    <SafeAreaView style={{ flex: 1 }} edges={['top', 'left', 'right', 'bottom']}>
      <SideBarContainer isShow={showSideBar} handleClose={setShowSideBar}>
        <View
          className="left-0 top-0 bottom-0 h-screen bg-white border border-gray-100"
          style={{
          ...
          <TouchableOpacity
            ...
            className="border-t border-t-gray-200 flex-row items-center"
            style={{
              paddingHorizontal: 16,
              paddingTop: 16,
              paddingBottom: 16,
            }} // gunakan safe area bottom
          >
            <View className="mr-3">
