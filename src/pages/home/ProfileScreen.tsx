import { Image, KeyboardAvoidingView, Modal, Platform, ScrollView, Text, TextInput, ToastAndroid, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native"
import Assets from "../../assets"
import { FC, useCallback, useState } from "react"
import { leaveGroupRequest, myGroupRequest, profileContactRequest, removeFromAdminGroupRequest, memberCommunity } from "../../services/home/profile"
...
import { userReportReasons, postReportReasons } from "../../constants/reportReason"
...
const Profile: FC<ProfileInterface> = ({ navigation, route }) => {
  ...
  console.log(detailDataGroup, 'detailDataGroup');
            ...
            <View style={{
              ...
              >
                <View style={{
                  ...
                  <Text className="font-bold text-lg mb-4 text-black">
                    {isGroup ? "Laporkan Grup" : "Laporkan Pengguna"}
                  </Text>

                  {/* Report Reason Radio Buttons */}
                  <Text className="font-medium text-sm mb-2 text-black">Alasan Laporan</Text>
                  {(isGroup ? postReportReasons : userReportReasons).map((reason, index) => (
                    <TouchableOpacity
                      key={index}
                    ...
                    >
                      <View
                        style={{
                          ...
                          borderRadius: 10,
                          borderWidth: 2,
                          borderColor: reportReason === reason ? "#f00" : "#ccc",
                          alignItems: "center",
                          justifyContent: "center",
                          marginRight: 10
                        }}
                  ...
                  {/* Description */}
                  <Text className="font-medium text-sm mb-2 text-black">Deskripsi (Opsional)</Text>
                  <TextInput
                  ...
                  {/* Evidence Images */}
                  <Text className="font-medium text-sm mb-2 text-black">Bukti (Gambar)</Text>
            ...
            <View style={{
              ...
              >
                <View style={{
                  ...
                  <Text className="text-center mb-4 text-black">
                    {blockMode === "block"
